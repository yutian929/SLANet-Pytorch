...
if __name__ == "__main__":
    ...
    def test_csppan():
        # Create a CSPPAN module with default parameters
        csppan = CSPPAN(
        ...
        # Create input tensors with all ones
        inputs = [
        ...
        # Run the CSPPAN module
        outputs = csppan(inputs)

        print(f'Output shapes: {[o.shape for o in outputs]}')

        # # Check the shape of the output tensors
        # for i, output in enumerate(outputs):
        #     assert output.shape == (1, 96, 224 // (2 ** i), 224 // (2 ** i))

        # # Check the values of the output tensors
